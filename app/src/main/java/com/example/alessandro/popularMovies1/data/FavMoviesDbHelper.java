...
import static com.example.alessandro.popularMovies1.data.FavMoviesContract.MoviesEntry;
import static com.example.alessandro.popularMovies1.data.FavMoviesContract.VideosEntry;
import static com.example.alessandro.popularMovies1.data.FavMoviesContract.ReviewsEntry;
...
class FavMoviesDbHelper extends SQLiteOpenHelper {
    ...
    // From StackOverflow - https://goo.gl/ievauA
    @Override
